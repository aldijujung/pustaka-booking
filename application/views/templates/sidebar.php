...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar"> 
	...
	<!-- Looping Menu-->
	<!-- Heading --> 
	<div class="sidebar-heading"> Menu Pustaka </div> 
		<!-- Nav Item - Dashboard --> 
		...
		<li class="nav-item"> 
			<a class="nav-link pb-0" href="<?= base_url('buku'); ?>"> <i class="fa fa-fw fa-book"></i> <span>Data Buku</span></a>
                ...
                <li class="nav-item"> 
			<a class="nav-link pb-0" href="<?= base_url('buku/kategori'); ?>"> <i class="fa fa-fw fa-book"></i> <span>Data Kategori Buku</span></a>
		</li>
		<li class="nav-item"> 
		...
		<br class="mt-3">
                <li class="nav-item"> 
			<a class="nav-link pb-0" href="<?= base_url('autentifikasi/logout'); ?>"> <i class="fa fa-fw fa-sign-out-alt"></i> <span>Log Out</span></a>
		</li>
                <br class="mt-3">
                <br class="mt-3">
